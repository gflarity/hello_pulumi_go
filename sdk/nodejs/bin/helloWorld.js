...
class HelloWorld extends pulumi.CustomResource {
    ...
    static get(name, id, opts) {
        return new HelloWorld(name, undefined, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, args, opts) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["loud"] = args ? args.loud : undefined;
            resourceInputs["name"] = args ? args.name : undefined;
            resourceInputs["message"] = undefined /*out*/;
        }
        else {
            resourceInputs["loud"] = undefined /*out*/;
            resourceInputs["message"] = undefined /*out*/;
            resourceInputs["name"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(HelloWorld.__pulumiType, name, resourceInputs, opts);
    }
}
exports.HelloWorld = HelloWorld;
/** @internal */
HelloWorld.__pulumiType = 'hello-pulumi-go:index:HelloWorld';
